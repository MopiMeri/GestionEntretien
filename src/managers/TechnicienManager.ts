...
export const handleGetAllTechniciens = async (
  request: Request,
  next: NextFunction
) => {
...
export const handlegetTechnicienById = async (
  id: string,
  next: NextFunction
) => {
...
export const handlePostTechnicien = async (
  request: Request,
  next: NextFunction
) => {
  try {
    if (
      ...
      throw new Error("Les champs nom, prenom et specialisation sont requis.");
    }
...
export const handleDeleteTechnicien = async (
  request: Request,
  next: NextFunction
) => {
  try {
...
export const handlePutTechnicien = async (
  request: Request,
  next: NextFunction
) => {
  try {
...
export const handleGetTechnicienWithFilters = async (
  request: Request,
  next: NextFunction
) => {
  try {
    ...
    if (techniciens.length === 0) {
      throw new Error("Aucun technicien trouvé avec les filtres fournis.");
    }
